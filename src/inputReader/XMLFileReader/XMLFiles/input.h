...
class linkedCellsColouringSingle_t: public ::xml_schema::type
{
  ...
  // Constructors.
  //
  linkedCellsColouringSingle_t (const leftLowerBound_type&,
                                const rightUpperBound_type&,
                                const cellSize_type&);

  linkedCellsColouringSingle_t (::std::unique_ptr< leftLowerBound_type >,
...
class linkedCellsColouringMultiple_t: public ::xml_schema::type
{
  ...
  // Constructors.
  //
  linkedCellsColouringMultiple_t (const leftLowerBound_type&,
                                  const rightUpperBound_type&,
                                  const cellSize_type&);

  linkedCellsColouringMultiple_t (::std::unique_ptr< leftLowerBound_type >,
                                  ::std::unique_ptr< rightUpperBound_type >,
                                  const cellSize_type&);
...
class linkedCellsColouringLocks_t: public ::xml_schema::type
{
  ...
  // Constructors.
  //
  linkedCellsColouringLocks_t (const leftLowerBound_type&,
                               const rightUpperBound_type&,
                               const cellSize_type&);

  linkedCellsColouringLocks_t (::std::unique_ptr< leftLowerBound_type >,
                               ::std::unique_ptr< rightUpperBound_type >,
                               const cellSize_type&);
...
class simTypes_t: public ::xml_schema::type
{
  ...
  const LinkedCellsColouringSingle_sequence&
  LinkedCellsColouringSingle () const;

  LinkedCellsColouringSingle_sequence&
  LinkedCellsColouringSingle ();
  ...
  const LinkedCellsColouringMultiple_sequence&
  LinkedCellsColouringMultiple () const;

  LinkedCellsColouringMultiple_sequence&
  LinkedCellsColouringMultiple ();
  ...
  const LinkedCellsColouringLocks_sequence&
  LinkedCellsColouringLocks () const;

  LinkedCellsColouringLocks_sequence&
  LinkedCellsColouringLocks ();
