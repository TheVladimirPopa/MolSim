...
class paraType_t: public ::xml_schema::string
{
  ...
  operator value () const
  {
    return _xsd_paraType_t_convert ();
  }
...
class membrane_t: public ::xml_schema::type
{
  ...
  const membraneForce_sequence&
  membraneForce () const;

  membraneForce_sequence&
  membraneForce ();
