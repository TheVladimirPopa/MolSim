...
const linkedCellContainer_t::cutOffRadius_type& linkedCellContainer_t::cutOffRadius() const {
  return this->cutOffRadius_.get();
}

linkedCellContainer_t::cutOffRadius_type& linkedCellContainer_t::cutOffRadius() { return this->cutOffRadius_.get(); }

void linkedCellContainer_t::cutOffRadius(const cutOffRadius_type& x) { this->cutOffRadius_.set(x); }
...
linkedCellContainer_t::linkedCellContainer_t(const leftLowerBound_type& leftLowerBound,
                                             ...
                                             const cellSize_type& cellSize, const cutOffRadius_type& cutOffRadius)
    : ::xml_schema::type(),
