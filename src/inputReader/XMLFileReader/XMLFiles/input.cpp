...
const simulation_t::MembraneMolecule_sequence& simulation_t::
MembraneMolecule () const
{
  return this->MembraneMolecule_;
}

simulation_t::MembraneMolecule_sequence& simulation_t::
MembraneMolecule ()
{
  return this->MembraneMolecule_;
}
...
void simulation_t::
MembraneMolecule (const MembraneMolecule_sequence& s)
{
  this->MembraneMolecule_ = s;
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< MembraneMolecule_type > r (
        MembraneMolecule_traits::create (i, f, this));
